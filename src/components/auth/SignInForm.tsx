...
export function SignInForm({ locale, labels }: SignInFormProps) {
  return (
    <div>
      <div className="flex flex-col gap-3">
        <button
          ...
          className="flex min-h-12 w-full items-center justify-center gap-3 rounded-sm border border-border bg-surface text-sm font-medium text-ink transition-colors duration-200 hover:border-ink font-body cursor-pointer"
        >
          <GoogleIcon />
          {labels.google}
        </button>
